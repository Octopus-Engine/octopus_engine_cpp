...
{
	Logger::getNormal() << "BuildingBlueprintCommand:: register Command "<<_player <<std::endl;
	...
	if(missingRes_l != "")
	{
		Logger::getNormal() << "BuildingBlueprintCommand:: missing resource "<<_player <<std::endl;
	...
	{
		Logger::getNormal() << "BuildingBlueprintCommand:: missing requirements "<<_player <<std::endl;
	...
	{
		Logger::getNormal() << "BuildingBlueprintCommand:: unexplored zone "<<_player <<std::endl;
	...
	else
	{
		if(noOutOfBounds(state_p, building_l) && _model->checkLegality(building_l, state_p))
		{
			...
			Logger::getNormal() << "BuildingBlueprintCommand:: spawn building "<<buildingHandle_l<<" for player "<<_player <<std::endl;
